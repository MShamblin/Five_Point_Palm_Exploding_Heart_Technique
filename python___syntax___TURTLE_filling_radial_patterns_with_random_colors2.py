"""Turtle - Filling Radial Patterns with Random Colors"""
...
def main():
    t = Turtle()
    t.speed(0)
    # Number fo shapes in radial pattern
    count = 10
    ...
    # Draw squares in the lower-left corner
    ...
    # Draw hexagons in the lower-right corner
